                  ...
                  <div className="border-t border-slate-100">
                    {proyecto.documentos.length === 0 ? (
                      ...
                      <div className="flex flex-col">
                        {proyecto.documentos.map((doc: any, idx: number) => (
                          <div
                            key={doc.id}
                            className={`flex items-center gap-2 px-4 py-2.5 hover:bg-slate-50/50 transition-colors ${idx < proyecto.documentos.length - 1 ? 'border-b border-slate-300 border-dashed' : ''}`}
                          >
