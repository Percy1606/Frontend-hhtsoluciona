  ...
  return (
    <>
      ...
      <DialogContent className="max-w-6xl w-full max-h-[94vh] overflow-hidden p-0 border-none bg-white shadow-2xl flex flex-col">
        <DialogHeader className="px-8 py-5 bg-primary text-white shrink-0 relative">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex-1 space-y-1.5">
              ...
              <DialogTitle className="text-2xl sm:text-3xl font-black tracking-tight leading-tight uppercase">{client.empresa}</DialogTitle>
        ...
        <div className="bg-slate-50 border-b border-slate-200 px-8 py-2.5 flex flex-wrap items-center justify-between gap-3 shrink-0">
        ...
        <Tabs defaultValue="general" value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden min-h-0">
          <div className="px-8 border-b border-border bg-slate-50/50 shrink-0">
            <TabsList className="bg-transparent h-11 w-full flex items-stretch rounded-none p-0">
              <TabsTrigger 
                value="general" 
                className="flex-1 data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none font-black text-xs uppercase h-full text-center justify-center"
              >
                Visión General
              </TabsTrigger>
              <TabsTrigger 
              ...
              <TabsTrigger 
                value="timeline" 
                className="flex-1 data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none font-black text-xs uppercase h-full text-indigo-600 data-[state=active]:text-primary gap-1 text-center justify-center"
              >
          ...
          <div className="flex-1 overflow-y-auto px-8 py-5">
            ...
            <TabsContent value="general" className="mt-0 space-y-4">
              ...
              {client.observaciones && (
                <div className="bg-primary/[0.02] p-4 rounded-xl border border-primary/5 space-y-1.5">
